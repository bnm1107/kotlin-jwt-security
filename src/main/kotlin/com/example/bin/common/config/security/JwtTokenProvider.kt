package com.example.bin.common.config.security


import com.example.bin.common.dto.jwt.TokenResponseDto
...
)
{
    ...
    val secretKey: Key = Keys.secretKeyFor(io.jsonwebtoken.SignatureAlgorithm.HS256)
